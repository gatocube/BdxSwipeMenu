...
/**
 * ~20 built-in SVG icons so BdxSwipeMenu works out of the box without any icon library.
 * Each value is the inner SVG content for a 24x24 stroke-based icon.
 * Consumers can override/extend via the `renderIcon` prop on BdxSwipeMenu.
 */
...
export function renderBuiltinIcon(
    name: string,
